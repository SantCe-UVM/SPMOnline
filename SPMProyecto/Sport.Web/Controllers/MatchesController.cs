...
namespace Sport.Web.Controllers
{
    public class MatchesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Sport,MatchDate,MatchLocation,MatchHours,MatchMinutes")] Match match)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Sport,MatchDate,MatchLocation,MatchHours,MatchMinutes")] Match match)
        {
            if (id != match.Id)
            {
                return NotFound();
