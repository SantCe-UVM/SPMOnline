...
namespace Sport.Web.Controllers
{
    public class TournamentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,FullName")] Tournament tournament)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FullName")] Tournament tournament)
        {
            if (id != tournament.Id)
            {
                return NotFound();
